...
public class RayCastTest : MonoBehaviour
{
    ...
    public HitDirection ReturnDirection(GameObject other, GameObject objectHit, Color rayColor)
    {
        ...
        Vector2 direction = (objectHit.transform.position - other.transform.position).normalized;
        //Ray MyRay = new Ray(objectHit.transform.position, direction);

        RaycastHit2D MyRayHit = Physics2D.Raycast(other.transform.position, direction);
